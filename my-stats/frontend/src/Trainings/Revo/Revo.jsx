...
export default function Revo() {
  ...
  useEffect(() => {
    fetch('http://localhost:3001/api/clubs')
      ...
      .then(data => {
        ...
        const revo = data.clubs.find(club => club.club_name === 'Révolution\'Air');
        setClubId(revo.club_id);
      });
  }, []);
  ...
  return (
    <div id="revoContainer">
      <form onSubmit={handleSubmit} className="revoForm">
